...
function checkstatus($viewtype, $competence)
{
  ...
  $query = "Select * from `invictus_review`.`sessiontime` Where viewtype Like '".$viewtype . "' and competence Like '".$competence. "' and username Like '". $_COOKIE['usname'] . "'";
    $datame = mysqli_query($daf, $query);
    $corrected = 0;
    $totalme = 0;
    $totalaverage = 0; 
...
<div class="row">
    <div class="col-md-offset-2 col-md-8">
        <h1>USERNAME: <?php echo $_COOKIE['usname']; ?></h1>
